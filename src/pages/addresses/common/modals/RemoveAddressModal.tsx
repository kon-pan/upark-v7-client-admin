...
const RemoveAddressModal = ({
  ...
  isOpen,
  closeModal,
  liftRemoveAddressSuccess,
}: {
  address: IAddress;
  isOpen: boolean;
  closeModal: () => void;
  liftRemoveAddressSuccess: (value: boolean) => void;
}) => {
  const removeDriver = async () => {
    const response: AxiosResponse = await axios.get(
      `${process.env.REACT_APP_SERVER_HOSTNAME}/admin/delete/address/${address.id}`,
